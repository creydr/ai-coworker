...
func TestParseIntent(t *testing.T) {
	tests := []struct {
		...
		{name: "exact info_lookup", response: "info_lookup", want: domain.IntentInfoLookup},
		...
		{name: "uppercase INFO_LOOKUP", response: "INFO_LOOKUP", want: domain.IntentInfoLookup},
		...
		{name: "info_lookup with whitespace", response: "  info_lookup\n", want: domain.IntentInfoLookup},
		...
		{name: "info_lookup in sentence", response: "this requires info_lookup to answer", want: domain.IntentUnknown},
