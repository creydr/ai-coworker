...
| `AI_COWORKER__GOOGLEDOCS__LISTEN_ADDR` | Address for the local webhook server (default `:8082`) |
| `AI_COWORKER__GOOGLEDOCS__WEBHOOK_URL` | Public HTTPS URL for Drive push notifications (e.g. ngrok URL) |
