...
func main() {
	...
	if cfg.GitHub.Enabled {
		var err error
		githubAdapter, err = github.New(cfg.GitHub.AppID, []byte(cfg.GitHub.PrivateKey), cfg.GitHub.WebhookSecret, cfg.GitHub.BotUsername, cfg.GitHub.ListenAddr, cfg.GitHub.AllowedUsers)
		if err != nil {
